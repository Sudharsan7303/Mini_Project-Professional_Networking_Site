            ...
            <div class="nav-wrapper"><!--main navigation-->
                <div class="container">
                    ...
                    <nav class="wsmenu slideLeft clearfix">
                        <div class="logo pull-left"><a href="index.php" title="Responsive Slide Menus"><h3 style="color:#08c2f3;font-size:30px;">PROFFESIONAL NETWORKING SITE</h3></a></div>
                        <ul class="mobile-sub wsmenu-list pull-right">
                            <li><a href="home.php" class="">Home</a>
                          ...
                          <li><a href="ServiceProvider.php">Be a service provider <span class="arrow"></span></a></li>
                        </ul>
                    </nav>
                </div>
